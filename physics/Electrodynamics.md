...
But here's one thing that may blow your mind! The charge should also be affect by Magnetic field(conjugate field of some electric field). The reason is that magnetic field is generated by some changing electric field. We can say that if there's a magnetic field, there must be a conjugate changing electric field exist. And the charge would be affected by that conjugate field.
